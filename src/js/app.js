...
class App {
      ...
      >
        <div class="offcanvas-header align-items-center">
          <h4 class="${
            ...
            <span>
              <img src="src/img/icon.ico" width="32" />
            </span>
  ...
  _updateData() {
    [
      ...
      this.#currentWeather.timezone.split("/")[1],
      this.#currentWeather._getWeatherForecast().weather,
      `/src/img/${this.#currentWeather._getWeatherForecast().icon}`,
      `
      <span class="h1" id="current-temperature">
        ${Math.round(this.#currentWeather.temperature)}
        <sup>${this.#currentWeather.tempUnit}</sup>
  ...
  _getCurrentDailyWeather(e) {
    ...
    <span id="timezone">
      ...
      `,
      `/src/img/${this.#currentDailyWeather._getWeatherForecast().icon}`,
  ...
  _renderSearchedCity(data, city) {
    ...
    [
      ...
      `/src/img/${this.#searcedCurrentWeather._getWeatherForecast().icon}`,
      `
